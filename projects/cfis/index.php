...
<body>
  ...
  <div class="modal" id="modal">
    ...
    <a href='index.html'>Home</a> <a href='index.php'>Panel</a> <a href='menu.html'>Options</a> <a href='logout.php'>Logout</a>
    <br><br>
  ...
  <div class="left-container">
    <div class='resume'>
      <?php 
          $userOn = isset($_SESSION['user']) ? $_SESSION['user'] : "";
          echo $welcome_msg = $userOn ? "Welcome <a href='user.php'>$userOn</a>" : "";
      ?>
      <h1>Cooperative File Information Service</h1>
      <br>    
<?php
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["register"])) {
    ...
    if (!isAlphaNumeric($username)){echo "Invalid username. Use only letters and numbers."; die;}
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr style='{$backgroundColor}'>
                ...
                <td>{$row['mime_type']}</td>
                <td><a href='invest.php?hash={$row['sha256_hash']}' target='_blank' class='invest'>Invest</a></td>
              </tr>";
