...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($fileContents !== false) {
        ...
        $sql = "INSERT INTO file_information (url, file_size, date, sha256_hash, connection_delay, mime_type)
                VALUES ('$url', '$fileSize', '$currentDate', '$hash', '$connectionDelay', '$mimeType')";
        if ($conn->query($sql) === TRUE) {
