...
$lastPicture = "<a href='$outputFilename'>$outputFilename</a><img src='$outputFilename' width='100%'></a>";
//echo "Image saved in: <a href='$outputFilename'>$outputFilename</a><br><img src='$outputFilename'>";
?>

<div id='view'></div>
<script>
    // This script enables the creation of a simple gallery by picking random images.
    ...
    function generateImageLink(category, random) {
        return `<a href='${category}/${random}.jpg' target='_blank'><img src='${category}/${random}.jpg' width='50%'></a>`;
    }
    ...
    var tableHtml = `<table width='100%'><tr><td valign='top' width='50%'><?php echo $lastPicture ?><br>Last picture created</td><td valign='top' width='50%'>Others pictures created<br>${img2}${img3}${img4}${img5}${img6}${img7}</td></tr></table>`;
